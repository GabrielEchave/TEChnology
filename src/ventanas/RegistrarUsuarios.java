...
public class RegistrarUsuarios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txt_email.setBackground(new java.awt.Color(49, 133, 221));
        ...
        txt_username.setBackground(new java.awt.Color(49, 133, 221));
        ...
        cmb_niveles.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Administrador", "Empleado", "Tecnico" }));
        ...
        jLabel_footer.setText("Creador por Gabriel Echave");
        getContentPane().add(jLabel_footer, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 295, -1, -1));

        jLabel_Wallpaper.setBackground(new java.awt.Color(49, 133, 221));
        jLabel_Wallpaper.setFont(new java.awt.Font("Arial", 0, 24)); // NOI18N
            ...
            if (rs.next()) {
                ...
                if (validacion == 0) {
                    try {
                        ...
                        this.dispose();//permite cerrar la interfas 
                        
                        
                    } catch (SQLException e) {
                        System.err.println("Error en registar usuario");
