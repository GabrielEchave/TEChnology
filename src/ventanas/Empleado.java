...
public class Empleado extends javax.swing.JFrame {
    ...
    public Empleado() {
        ...
        try {
            ...
            System.out.println("Error en consultar nombre de Empleado");
        }
    ...
    private void jButton_ImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ImprimirActionPerformed
        ...
        try {
            ...
            parrafo.setFont(FontFactory.getFont("Arial",18,Font.BOLD, BaseColor.DARK_GRAY));//Tipo de letra, tamaño y diseño del texto
            
            //Abrimos el documento y agregamos el header y el texto
            documento.open();
            documento.add(header);
            documento.add(parrafo);
            
            //Agregamos la informacion de la base de datos
            //Creamos la tabla donde se guardaran los datos de la bd
            PdfPTable tabla = new PdfPTable(5); //definimos cuantas columnas tendra la tabla 
            tabla.addCell("ID");
            tabla.addCell("Nombre");
            tabla.addCell("Email");
            tabla.addCell("Telefono");
            tabla.addCell("Direccion");
            //nos conectamos a la bd para poder sacar los datos que necesitamos
            try {
                Connection cn = Conexion.conectar();
                PreparedStatement pst = cn.prepareStatement("select * from clientes");//seleccionamos todos los datos de la base de datos
                ResultSet rs = pst.executeQuery();
                ...
                if (rs.next()) {
                    ...
                    } while (rs.next());//se van a ir guardando los datos en la tabla 
                    documento.add(tabla);//agregamos la tabla al documento
                }
                
            } catch (SQLException e) {
                System.err.println("Error al generar lista de cliente");//sirve para que el programador sepa si hay algun error
            }
            documento.close();
