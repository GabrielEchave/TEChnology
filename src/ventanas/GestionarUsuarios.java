...
public class GestionarUsuarios extends javax.swing.JFrame {
    ...
    DefaultTableModel model = new DefaultTableModel(); //permite un acceso para modificar la tabla
    ...
    public GestionarUsuarios() {
        ...
        try {
            ...
            jScrollPane1.setViewportView(jTable_usuarios);//nos permite poder scrolear por si la table es muy grande
            ...
            while(rs.next()){//es para ver si la bd encontro coincidencias 
            ...
            JOptionPane.showMessageDialog(null, "Error al mostrar informacion, llamar ");
        }
        
        //Evento que permite mostrar la informacion general de cada campo al darle clic
