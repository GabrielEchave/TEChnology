...
public class InformacionUsuario extends javax.swing.JFrame {
    ...
    public InformacionUsuario() {
        ...
        try {
            ...
            System.err.println("Error al cargar usuarios "+e);
            JOptionPane.showMessageDialog(null, "Error al cargar, contacte al administrador"+e);
        }
    ...
    private void initComponents() {
        ...
        txt_registradoPor.setBackground(new java.awt.Color(49, 133, 221));
        ...
        jButton_RestaurarPassword.setBackground(new java.awt.Color(49, 133, 221));
                ...
                if (rs.next()) {
                    ...
                    PreparedStatement pst2 = cn3.prepareStatement(
                        "update usuarios set nombre_usuario=?, email=?, telefono=?, username=?,"
                                + " tipo_nivel=? , estatus=? where id_usuarios = '"+ID+"'");
