...
public class InformacionEquipoTecnico extends javax.swing.JFrame {
    ...
    private void jButton_ActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarActionPerformed
        ...
        try {
            Connection cn = Conexion.conectar();
            PreparedStatement pst = cn.prepareStatement(
                "update equipos set estatus=?, comentarios_tecnicos=?, revicion_tecnica_de=? "
            ...
            pst.executeUpdate();
            cn.close();
            JOptionPane.showMessageDialog(null, "Actualizacion equitosa");
            this.dispose();
        } catch (SQLException e) {
            System.err.println("Error al actualizar equipo, informacion equipo tecnico");
            JOptionPane.showMessageDialog(null, "Error al actualizar equipo, informacion equipo tecnico");
        }
