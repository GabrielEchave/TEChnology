...
public class Login extends javax.swing.JFrame {
     ...
     */
    public Login() { //Constructor del acceso al programa
        initComponents();
        setSize(400,550);//permite indicarle a la clase el tamanio de la interfas
        setResizable(false);//perimete que el usuario no modifique las dimenciones de la interfas
        setTitle("Acceso al sistema");
        setLocationRelativeTo(null);//permite centrar la interfas en la pantalla
        ...
        ImageIcon wallpaper_logo = new ImageIcon("src/images/TECH.png");
    ...
    private void initComponents() {
        ...
        txt_user.setBackground(new java.awt.Color(49, 133, 221));
        ...
        getContentPane().add(txt_password, new org.netbeans.lib.awtextra.AbsoluteConstraints(95, 380, 210, -1));

        jButton_Acceder.setBackground(new java.awt.Color(49, 133, 221));
        ...
        getContentPane().add(jButton_Acceder, new org.netbeans.lib.awtextra.AbsoluteConstraints(95, 430, 210, 30));

        jLabel_Footer.setText("Creado por Gabriel Echave");
        getContentPane().add(jLabel_Footer, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 490, 150, -1));
